...
You can also set the task as complete by clicking on a check button, which turns the task green. Regualry hovring over a note will turn it blue, and while hovering over a note in delete mode will turn it 
red