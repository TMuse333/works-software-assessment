...
const HydroList = ({absolute}) => {
    ...
    const handleContentClick = (index) => {
        ...
        const expandedIndex = expandedIndex.findIndex(index => index )

      else if(expandedIndex.includes(expandedIndex[index])){
        // setCompletedTasks(prevTasks => prevTasks.filter((_, i) => i !== taskIndex));
        setExpandedIndex(prevIndex => prevIndex.filter((_,i) => i !== index));
       console.log('aready in there')
       }
       else{
        setExpandedIndex((prevIndex) => [...prevIndex, tasks[index]])
       }   
      };
