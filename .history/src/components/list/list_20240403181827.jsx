...
const HydroList = ({absolute}) => {
    ...
    const handleContentClick = (index) => {
      ...
      const hydroStyle = (index) => {
        ...
        return {
            ...
            transition: 'background-color 0.3s ease-in, border-bottom 0.3s ease-in, border 0.3s ease-in, width 0.3s ease-in 0.3s', // Separate transitions with a delay for width
            backgroundColor: noteDelete ? 'red' : 'auto',
      ...
      const contentStyle = (index, description) => {
        ...
        const height = isExpanded ? `${wordCount * 20}px` : '0'; 
    ...
    return (
        ...
        style={finalWarningStyle()}>
                ...
                <section> 
                    <button
                    onClick={handleFinalDeletion}>Delete</button>
