...
//styling of the checkmark, if it is hovered over, it will turn green
    ...
    //hovering over it in deletion mode, causing red and
    //green for when the task is finished

      const taskStyle = (index) => {
    ...
    //styling based to change the height of the content box
    //if the box has been clicked and calculating the height of
    // the expanded box based off how many words are in the 
    //description
      ...
      //styling of the final warning before deletion
...
<div className="main-list-container">
        ...
        {addNote && (
            ...
            <label htmlFor="description">
                <textarea
                className="descripiton-container"
               type='name'
                name='description'
