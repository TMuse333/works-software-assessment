...
router.post('/notes', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var note, newNote, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                note = req.body.note;
                newNote = new note_model_1.default({ note: note });
            ...
            case 2:
                error_1 = _a.sent();
                res.status(500).json({ success: false, message: 'Internal server error', error: error_1.message });
                return [3 /*break*/, 3];
...
router.get('/notes', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, note_model_1.default.find()];
            case 1:
                notes = _a.sent();
            ...
            case 2:
                error_2 = _a.sent();
                res.status(500).json({ success: false, message: 'Internal server error', error: error_2.message });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
