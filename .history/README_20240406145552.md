...
To fix this solution I learned how to use vitest and writing tests with render and fire event from jest dom and testing library/react and using some functions from their library like getByText, getById